  ...
  return (
    <div className={cn("relative", className)} ref={menuRef}>
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((o) => !o)}
        className="rounded-md border border-neutral-300 bg-white px-2 py-1 text-sm hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:bg-neutral-800"
      >
        Actions
      </button>
      {open ? (
